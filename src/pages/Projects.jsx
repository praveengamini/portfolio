  ...
  return (
    <div className="grid gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4  bg-gradient-to-r from-indigo-100 via-indigo-200 to-indigo-300 p-4">
      <Card className='max-w-sm shadow-lg transform transition-all duration-500 hover:scale-105 hover:shadow-xl'>
        ...
        <h2 className='text-center text-xl font-bold text-gray-800 hover:text-indigo-600 transition-colors duration-300'>Quick Mart</h2>
        <CardDescription className='text-center text-lg font-medium text-gray-600'>
      ...
      <Card className='max-w-sm shadow-lg transform transition-all duration-500 hover:scale-105 hover:shadow-xl'>
        ...
        <h2 className='text-center text-xl font-bold text-gray-800 hover:text-indigo-600 transition-colors duration-300'>Smart-Fit</h2>
        <CardDescription className='text-center text-lg font-medium text-gray-600'>
      ...
      <Card className='max-w-sm shadow-lg transform transition-all duration-500 hover:scale-105 hover:shadow-xl'>
        ...
        <h2 className='text-center text-xl font-bold text-gray-800 hover:text-indigo-600 transition-colors duration-300'>Basic Java E-commerce</h2>
        <CardDescription className='text-center text-lg font-medium text-gray-600'>
      ...
      <Card className='max-w-sm shadow-lg transform transition-all duration-500 hover:scale-105 hover:shadow-xl'>
        ...
        <h2 className='text-center text-xl font-bold text-gray-800 hover:text-indigo-600 transition-colors duration-300'>SmartStudy</h2>
        <CardDescription className='text-center text-lg font-medium text-gray-600'>
      ...
      <Card className='max-w-sm shadow-lg transform transition-all duration-500 hover:scale-105 hover:shadow-xl'>
        ...
        <h2 className='text-center text-xl font-bold text-gray-800 hover:text-indigo-600 transition-colors duration-300'>Clock</h2>
        <CardDescription className='text-center text-lg font-medium text-gray-600'>
